...
function TasksReport() {
  ...
  // Mock data for task status chart
  ...
  // Mock data for task overview chart
      ...
      <div className="bg-white rounded-lg shadow-sm mb-6">
        <div className="p-4 sm:p-4 lg:p-6">
          <div className="flex items-center justify-between">
            <h1 className="text-xl sm:text-2xl font-bold text-gray-800">Tasks Report</h1>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white rounded-lg shadow-sm">
          <div className="p-4 sm:p-6 border-b border-gray-200">
            <h4 className="text-lg font-semibold text-gray-800">Task Status Distribution</h4>
          </div>
        ...
        <div className="bg-white rounded-lg shadow-sm">
          <div className="p-4 sm:p-6 border-b border-gray-200">
            <h4 className="text-lg font-semibold text-gray-800">Tasks Overview</h4>
          </div>
          <div className="p-4 sm:p-6">
            <div className="h-64">
              <Bar data={taskOverviewData} options={barChartOptions} />
            </div>
          </div>
        </div>
      </div>
